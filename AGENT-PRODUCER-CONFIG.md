...
- **Producer launch template:**
  ...
  ```
  **Note:** `<NUM_PRODUCERS>` is configurable (e.g., 8, 16, 32, 64). The actual value should be specified when invoking the experiment based on the desired producer-consumer ratio.
