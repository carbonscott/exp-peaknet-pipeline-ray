...
- **lclstreamer config file:** `examples/lclstreamer-psana1-to-sdfada-numpy.yaml`
- **Producer launch template:**
  ```
  pixi run --environment psana1 mpirun -n <NUM_PRODUCERS> lclstreamer --config examples/lclstreamer-psana1-to-sdfada-numpy.yaml
  ```
